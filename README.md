...
Check out [FRONTEND LIVE DEMO](https://rachelle-restro-cafe.herokuapp.com/) here!!

Check out [API LIVE DEMO](https://rachelle-restro-cafe-backend.herokuapp.com/) here!!
...
```
git clone https://github.com/rachellepie/restro-cafe-project-minieCommerce.git
```
